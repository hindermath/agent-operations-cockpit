...
- Review-ID: `7667b091-eb3d-42e8-b3dd-cf52cc1175d1`
- Modus / Mode: `Single`
...
- Request: `specs/intake-review-requests/meta-lh-03-authoring-contract-2026-08-08-r3.json`
- Request-SHA-256: `ed2377f20f89cdf4c5be9b054de76bd70fd111223709392c6fbfacc15434ea50`
- Supersedes: `specs/intake-review-results/meta-lh-03-authoring-contract-2026-08-01-r2.json`
...
- Authoring Receipt `specs/intake-authoring-receipts/META-LH-03-Authoring-Contract.json`: Bash und PowerShell `PASS`.
- Single Review `specs/intake-review-results/meta-lh-03-authoring-contract-2026-08-08-r3.json`: Bash und PowerShell `PASS` nach Publikation.
