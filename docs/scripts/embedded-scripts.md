...
| `specs/002-portfolio-ownership/contracts/test_validate_meta_lh02_snapshot.py` | `specs` |
...
| `specs/intake-review-fixtures/raw-04/validate-presentation-contract.ps1` | `specs` |
| `specs/intake-review-fixtures/raw-04/validate-presentation-contract.py` | `specs` |
| `specs/intake-review-fixtures/raw-04/validate-presentation-contract.sh` | `specs` |
| `specs/intake-review-fixtures/raw-05/validate-execution-node-contract.ps1` | `specs` |
| `specs/intake-review-fixtures/raw-05/validate-execution-node-contract.py` | `specs` |
| `specs/intake-review-fixtures/raw-05/validate-execution-node-contract.sh` | `specs` |
| `specs/intake-review-fixtures/raw-06/validate-cli-capability-contract.ps1` | `specs` |
| `specs/intake-review-fixtures/raw-06/validate-cli-capability-contract.py` | `specs` |
| `specs/intake-review-fixtures/raw-06/validate-cli-capability-contract.sh` | `specs` |
| `specs/intake-review-fixtures/raw-07/validate-hardware-capability-contract.ps1` | `specs` |
| `specs/intake-review-fixtures/raw-07/validate-hardware-capability-contract.py` | `specs` |
| `specs/intake-review-fixtures/raw-07/validate-hardware-capability-contract.sh` | `specs` |
| `specs/intake-review-fixtures/raw-08/validate-workflow-evidence-contract.ps1` | `specs` |
| `specs/intake-review-fixtures/raw-08/validate-workflow-evidence-contract.py` | `specs` |
| `specs/intake-review-fixtures/raw-08/validate-workflow-evidence-contract.sh` | `specs` |
| `specs/intake-review-fixtures/raw-09/validate-preset-evolution-contract.ps1` | `specs` |
| `specs/intake-review-fixtures/raw-09/validate-preset-evolution-contract.py` | `specs` |
| `specs/intake-review-fixtures/raw-09/validate-preset-evolution-contract.sh` | `specs` |
