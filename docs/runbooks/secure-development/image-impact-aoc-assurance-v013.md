# image-impact: AOC-Feldtest / AOC field test
...
genehmigter Governance-Scope ohne Produktlauf. Nur image-impact prüfen.
...
scope. Review only image-impact; compare ordinal relative paths and raw SHA-256 of all
...
```bash
bash .specify/presets/secure-development-assurance-governance/scripts/validate-secure-development-assurance.sh review image-impact aoc-assurance-v013 training
```

```powershell
pwsh -NoProfile -File .specify/presets/secure-development-assurance-governance/scripts/validate-secure-development-assurance.ps1 -Action Review -Gate image-impact -ContextId aoc-assurance-v013 -Mode training
```
