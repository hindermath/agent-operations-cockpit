...
eine nachvollziehbare Selbstpruefung, ob AgentOperationsCockpit die Anforderungen aus
...
AgentOperationsCockpit ist ein Repository in der Level-1-/Level-2-Arbeitsstruktur.
...
```text
/speckit-specify
Nutze Lastenheft_RL-SE-Checklist-Selbstpruefung.md als verbindlichen Intake fuer einen separaten RL-SE-/Checklist-Selbstpruefungslauf in AgentOperationsCockpit.
