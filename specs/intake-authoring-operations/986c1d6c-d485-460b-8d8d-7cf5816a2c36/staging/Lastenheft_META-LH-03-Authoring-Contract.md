...
**Intake ID:** `83b9481e-bc4c-4e3d-b67a-1c6c8d05a681`
**Erneuerung / Renewal:** Operation `986c1d6c-d485-460b-8d8d-7cf5816a2c36`, Receipt `f41328cd-b301-4533-89dc-02aab758ab1f`
...
Die einmalig ausdrücklich genehmigte Erneuerung dieses Lastenhefts ist als
Operation `986c1d6c-d485-460b-8d8d-7cf5816a2c36` Teil des aktuellen Laufs.
Außerhalb liegen jede weitere Update- oder Delete-Operation, die Ausführung
erzeugter Prompts, Produktimplementierung, Provider-Administration,
Admin-Bypass und Preset-Promotion. / *The one explicitly approved renewal of
this intake is part of the current run under the stated operation ID. Every
other update or delete, execution of generated prompts, product
implementation, provider administration, Admin bypass, and preset promotion
remain out of scope.*
...
| Artefakt / Artifact | Pfad / Path | Normalisierter SHA-256 / Normalized SHA-256 |
|---|---|---|
| Intake-Kern / intake core | `.specify/presets/intake-authoring-governance/templates/intake-template.md` | `835f0de4494b02f2dd47c386f3a87d3e908fa5bd2da35b4173f8358aeee614d0` |
| Receipt-Schema / Receipt schema | `.specify/presets/intake-authoring-governance/templates/intake-authoring-receipt-template.json` | `83b723286ea5be4c14ecf6b98538193a00651a159237f4d01193ac598056d7c1` |
| Repositoryprofil / repository profile | `.specify/presets/intake-authoring-governance/templates/project-profile-template.md` | `4c1ecc785937b6dacb0330efdd656e7b21eba1ac309b905cce8988b7404953f2` |
| AOC-Sammlungsvertrag / AOC collection contract | `requirements/intake-governance.json` | `e4f3a04e04af10fc64102d6200435d767437bdd4eda7819ba8890194b006a016` |
| Paket- und Feldnachweis / package and field evidence | `.specify/presets/intake-authoring-governance/templates/field-validation-summary.md` | `d2bfe1d9893c04a1952574cafa61d2f952400d058e82c3333ae9da13e7e86bfa` |
