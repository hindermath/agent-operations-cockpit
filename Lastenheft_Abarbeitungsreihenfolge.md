...
| 4 | Completed | [Lastenheft_META-LH-04-Series-Eligibility.004-series-eligibility.md](requirements/intakes/active/Lastenheft_META-LH-04-Series-Eligibility.004-series-eligibility.md) | [Lastenheft_META-LH-03-Authoring-Contract.003-authoring-contract.md](requirements/intakes/active/Lastenheft_META-LH-03-Authoring-Contract.003-authoring-contract.md) → current (`HardCompletionGate`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
| 5 | Completed | [Lastenheft_META-LH-05-Erste-Welle.md](requirements/intakes/active/Lastenheft_META-LH-05-Erste-Welle.md) | [Lastenheft_META-LH-04-Series-Eligibility.004-series-eligibility.md](requirements/intakes/active/Lastenheft_META-LH-04-Series-Eligibility.004-series-eligibility.md) → current (`HardCompletionGate`, binding: true) | — (kein Spec-Kit-Feature / no Spec Kit feature) |
