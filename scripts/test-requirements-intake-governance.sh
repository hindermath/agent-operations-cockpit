...
A11Y_LINEAR_DIR="$SCRIPT_DIR/tests/linked-intake-evidence/accessibility/linearized"
A11Y_DIAGNOSTICS="$SCRIPT_DIR/tests/linked-intake-evidence/accessibility/diagnostics/reference.json"
